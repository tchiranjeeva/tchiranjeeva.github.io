...
<img src="{{ '/assets/img/projects/circular-led-board.png' | relative_url }}" alt="Circular LED board render">

## Overview

- **Form factor:** Circular PCB
- **Power:** LDO voltage regulator
- **Protection:** TVS diode for voltage spikes and transients
